...
import furhatos.app.courseadvisor.flow.main.ListCourses
...
val Init: State = state {
    ...
    onEntry {
        /** start interaction */
        when {
            furhat.isVirtual() -> goto(ListCourses) // Convenient to bypass the need for user when running Virtual Furhat
            users.hasAny() -> {
